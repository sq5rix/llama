...
from parser import init_db, save_to_db, get_page_content
...
InitialURL = 'https://theoryofeverything.info'
...
def ProcessURL(url, src = None, obj = None):
    ...
    if found == False:
        ...
        temp['obj'] = obj
        temp['sta'] = None
        page_data, links, images = get_page_content(url)
        if page_data:
            save_to_db(page_data, links, images)
        queue.append(temp)
